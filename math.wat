(module
  ...
  ;; Below are three approaches to write the distance function.
  ...
  (func $distance
    ...
    (f64.sqrt
      (f64.add
        (f64.mul
          ;; There is no `dup` or `pick` instruction to duplicate the
          ;; value at the top of the stack, so we have to do this twice.
